...
namespace VMFactory.Api.Business.Templates
{
...
<body>
    ...
    <p class=""MsoPlainText"">
        <strong>Your request has been successfuly registered. </strong>
    </p>
    <p class=""MsoPlainText"">
        &nbsp;</p>
    <p class=""MsoPlainText"">
        The current version of the platform allows you to download pre-built VMs, based on the template you have selected. In the near future a lot more choices and custom configurations will be available.</p>
    <p class=""MsoPlainText"">
        &nbsp;</p>
    <p class=""MsoPlainText"">
        We have identified the following pre-built VMs based on your selected template:</p>
    <p class=""MsoPlainText"">
        &nbsp;</p>
    <p class=""MsoPlainText"">
