...
#Write-Output "       vhdPath: $vhdPath"
Write-Output "   driveLetter: $driveLetter"
Write-Output "      dismPath: $dismPath"
Write-Output "        vmName: $vmName"
Write-Output "          vmId: $vmId"
Write-Output "vmStatusSvcUrl: $vmStatusSvcUrl"
Write-Output "   cfgFileName: $cfgFileName"

#
$cfgFilePath = $driveLetter + "\" + $cfgFileName

# Identify system hard disk from VM
