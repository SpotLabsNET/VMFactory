...
param(
	[string]$cfgFilePath = 'W:\Projects\ALMRangers\VisualStudio.ALM\vsarVmFactory\dev\code\VMFactory.4\Api\VMFactory.Api.HyperV\PsScripts',  #param - VM configuration file path
	[string]$cfgFileName = 'Update-VMRequestStatus.xml', #param - VM configuration file 
	[string]$currentState = 'None', #param - VM current state
