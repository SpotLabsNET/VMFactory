...
namespace VMFactory.Api.HyperV.Finalization
{
    /// <summary>
    ...
    public class VMFinalization
    {
        ...
        /// <returns></returns>
        public bool FinalizeVM(
            String vmName, 
            String dropLocation, 
            long sizeOfEachVolume, 
            String processingLocation = null, 
            ICollection<String> usersToEmail = null)
        {
            HyperVPsInterface hyperVInterface = new HyperVPsInterface();
            string vhdPath = hyperVInterface.GetVHDPath(vmName);
